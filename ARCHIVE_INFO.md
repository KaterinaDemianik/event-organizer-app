...
Звичайні (авторизовані) користувачі можуть переглядати архівні події через вкладку **"Архів"** на сторінці списку подій (`/events/`). Staff користувачі мають доступ до архіву через адмін-панель або сторінку списку подій.

### Видимість архівних подій:

- **Staff користувачі** - бачать усі архівні події
- **Звичайні (авторизовані) користувачі** - бачать архівні події тільки якщо:
  - Вони є організатором події, АБО
  - Вони були учасниками події (мали RSVP)
- **Анонімні користувачі** - не мають доступу до архіву
...
| Статус | Опис | Дії |
|--------|------|-----|
| **draft** | Чернетка | Редагування, публікація, скасування |
